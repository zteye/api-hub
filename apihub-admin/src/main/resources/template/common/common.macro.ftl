<#macro commonName>接口集成API-HUB</#macro>
...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini">XXL</span>
			<span class="logo-lg"><@netCommon.commonName /></span>
		</a>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "interface">active</#if>" ><a href="${request.contextPath}/interface"><i class="fa fa-circle-o text-aqua"></i><span>接口管理</span></a></li>
				<li class="nav-click <#if pageName == "iomapping">active</#if>" ><a href="${request.contextPath}/iomapping"><i class="fa fa-circle-o text-aqua"></i><span>参数转换</span></a></li>
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>XXL-GLUE</b> 1.3
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="https://github.com/xuxueli/xxl-glue" target="_blank" >github</a>&nbsp;
                <a href="https://my.oschina.net/xuxueli/blog/732499" target="_blank" >oschina</a>
