        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    <a href="${request.contextPath}" class="navbar-brand"><b>INPUT Web</b>IDE</a>
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active" ><a href="javascript:;"> GLUE：${codeInfo.interfaceId}<span class="sr-only">(current)</span></a></li>
                    </ul>
                </div>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li <#if codeLogList?exists && codeLogList?size gt 0 >style="display: none;" </#if> >
                                    <a href="javascript:;" class="source_version" version="version_now"  >
                                        当前版本
                                        <textarea id="version_now" style="display:none;" >${codeInfo.outputRule}</textarea>
                                    </a>
                                </li>
...
<script src="${request.contextPath}/static/js/output.webide.js"></script>
